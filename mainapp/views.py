...
from mainapp.models import Category, Customer, Order, CartProduct, Product
...
class AddToCartView(CartMixin, View):
    def get(self, request, *args, **kwargs):
        ...
        if created:
            self.cart.products.add(cart_products)
...
class DeleteFromCartView(CartMixin, View):
    def get(self, request, *args, **kwargs):
        ...
        self.cart.products.remove(cart_products)
...
class CheckoutView(CartMixin, View):
    def get(self, request, *args, **kwargs):
        stripe.api_key = "sk_test_51JI51yLXL5RGZj48p8kd58CO9f2JIGmlljlkX7x1vnDcf4eNhNJTR2JTRadFS1TzTwi9UK8YaE24Wq1LLnyMI8jw00csEUcduE"
