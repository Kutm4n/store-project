# Generated by Django 3.1.7 on 2021-06-28 11:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sd', models.BooleanField(default=True, verbose_name='Слот SD-карты')),
                ('sd_volume', models.CharField(blank=True, max_length=255, null=True, verbose_name='Максимальный объем SD-карты')),
                ('mani_cam_mp', models.CharField(max_length=255, verbose_name='Основная камера')),
